...
function BrandBlock({ audience }) {
  ...
  return (
    <div className="hero-brand" aria-hidden="true">
      <img className="mascot-img" src={window.__resources.mascotImg} alt="Labu, mascote da Labuu" />
    ...
    <div data-screen-label="Labuu LP" data-audience={audience}>
      ...
      <nav className="nav">
        <div className="wrap nav-inner">
          <div className="logo">
            <img className="logo-wordmark" src={window.__resources.logoImg} alt="Labuu" />
          </div>
      ...
      <div className="guarantee-wrap" data-screen-label="Garantia">
        <div className="wrap">
          <div className="guarantee">
            ...
            <div className="seal">
              <img src={window.__resources.supportImg} alt="Suporte Labuu" />
